...
class PlaylistService {
  ...
  /**
   * TODO -stpham: Implémenter la récupération de toutes les playlists
  ...
  /**
   * TODO -stpham: Implémenter la récupération d'une playlist en fonction de son id
  ...
  /**
   * TODO -stpham: Implémenter l'ajout d'une nouvelle playlist
  ...
  /**
   * TODO -stpham: Implémenter la mise à jour d'une playlit existante
  ...
  /**
   * TODO -stpham: Implémenter la recherche pour les 3 champs des playlists. Astuce : utilisez l'opérateur '$or' de MongoDB
   *
  ...
  async search (substring, exact) {
    const nameFilter = { name: { $regex: `${substring}`, $options: exact ? "" : "i" } };
    const descriptionFilter = { description: { $regex: `${substring}`, $options: exact ? "" : "i" } };
