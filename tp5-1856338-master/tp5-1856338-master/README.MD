...
- Le like sur les chansons n'est pas fonctionnel (page blanche).
- La délétion n'est que partiellement fonctionnelle pour une playlist.
- Il manque un petit espacement au sein de la barre du footer (laBibliothèque collé).
- Excellent TP, bravo !
