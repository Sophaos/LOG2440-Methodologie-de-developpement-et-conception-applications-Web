...
export default function CreatePlaylist() {
  ...
  const handleSubmit = async (event) => {
    ...
    // TODO -stpham: envoyer la bonne requête pour ajouter ou modifier une playlist en fonction de l'attribut params.id
  ...
  // TODO -stpham: Gérer le changement de nom
  const handleNameChange = (event) => {
    setData({ ...data, name: event.target.value });
  };

  // TODO -stpham: Gérer le changement de description
  ...
  // TODO -stpham: Envoyer une requête de supression au serveur et naviguer vers la page principale
    ...
    <main id="main-area" className="flex-row">
      <form className="form-group" id="playlist-form">
        <div id="general-info" className="flex-row">
          <fieldset className="form-control">
            ...
            <div className="form-control flex-row">
              ...
              {/*TODO -stpham: lier au nom de la playlist */}
              <input
                type="text"
                id="name"
                value={data.name}
            ...
            <div className="form-control flex-row">
              ...
              {/*TODO -stpham: lier à la description de la playlist */}
              <input
                type="text"
                id="description"
        ...
        <fieldset className="form-control">
          ...
          {/*TODO -stpham: construire les choix de chansons dans des éléments <option> */}
        ...
        {/*TODO -stpham: afficher "Modifier la playlist" ou "Ajouter la playlist" en fonction de l'état du formulaire */}
        <input
          type="submit"
