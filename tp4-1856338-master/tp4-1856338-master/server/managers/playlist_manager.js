...
class PlaylistManager {
  ...
  /**
   * TODO -stpham: Implémenter la mise à jour de la playlist et du fichiers de toutes les playlists
  ...
  async updatePlaylist (playlist) {
    ...
    if (index !== -1) {
      ...
      playlist.thumbnail = oldPlaylist.thumbnail;
