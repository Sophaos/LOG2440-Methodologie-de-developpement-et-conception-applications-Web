...
import { playlists as samplePlaylists } from "../../src/assets/js/playlists.js";
...
describe("Library tests", () => {
  ...
  const setUpHTML = () => {
    // TODO -stpham ok: compléter la configuration du HTML pour les conteneurs de Playlists et Chansons
  ...
  it("generateLists should call buildPlaylistItem and buildSongItem, and append children to containers", () => {
    ...
    const playlist = [samplePlaylists[0]];
    ...
    expect(songContainer.childElementCount).toEqual(1);
  });
